...
Welcome to the collaborative Anki deck `{{DECK_NAME}}`. This deck is managed through [AnkiOps](https://github.com/visserle/AnkiOps), a bidirectional bridge between Anki and the filesystem. AnkiOps allows you to edit your decks in user-friendly Markdown files and to collaborate with others through GitHub.

- [Subscribe to this deck](#subscribe-to-this-deck)
- [Keep the deck current](#keep-the-deck-current)
- [Contribute to this deck](#contribute-to-this-deck)
- [Maintain this deck as a publisher](#maintain-this-deck-as-a-publisher)
...
ankiops fa  # shortcut for ankiops files-to-anki
```
...
Submitting requires the [GitHub CLI](https://cli.github.com/) (`gh`) to be installed and authenticated.

Edit your subscribed notes with either workflow:

- Edit the Markdown files under `collab/{{REPOSITORY}}/`.
- Edit cards in Anki, then run `ankiops af` (the shortcut for `ankiops anki-to-files`) to write those changes back to the deck files.
