...
from ..domain.payloads import NotePayload as LlmNotePayload
...
class ProviderRuntime:
    ...
    def prepare_attempt_request(
        ...
        *,
        ...
        llm_payload = _to_llm_payload(note_payload)
        contract = build_note_update_contract(llm_payload)
...
def _to_llm_payload(payload: NotePayload) -> LlmNotePayload:
    return LlmNotePayload(
